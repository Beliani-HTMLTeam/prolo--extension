...
// export async function saveZipToStorage(zipFile: Blob | File): Promise<void> {
...
// export async function getZipFromStorage(): Promise<Blob | File | null> {
//   const db = await openDatabase()
...
// export async function clearZipStorage(): Promise<void> {
//   const db = await openDatabase()
...
// export async function extractFileFromZip(fileName: string): Promise<File | null> {
...
// export async function getZipFileList(): Promise<string[]> {
//   const zipBlob = await getZipFromStorage()
//   if (!zipBlob) return []
