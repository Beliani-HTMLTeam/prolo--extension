...
export default function LoadForOne(): ReactElement {
  ...
  const handleZipUpload = async (e: React.ChangeEvent<HTMLInputElement>): Promise<void> => {
    try {
      ...
      browser.runtime.sendMessage(
        ...
        async response => {
          if (response?.status === 'success') {
            ...
            const filesBySlug: Record<string, SlugData> = {};
            ...
            const processData: ProcessDataItem[] = [];

            const addShop = (targetSlug: string, sourceSlug: string): void => {
